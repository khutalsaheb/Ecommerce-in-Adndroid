...
import com.sudnya.ecomm.Activity.SearchActivity;
...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.ViewHolder> {
    ...
    public SearchAdapter(List<HomeModel> homeModelList, Context context) {
        super();
    ...
    public void onBindViewHolder(ViewHolder Viewholder, int position) {
        ...
        Viewholder.wishlist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                SearchActivity.getInstance().addtoWishlist(homeModel);
        ...
        Viewholder.setClickListener(new ItemClickListener() {
            public void onClick(View view, int position, boolean isLongClick) {
                if (isLongClick) {
                    SearchActivity.getInstance().addNewModules(homeModel);
                } else {
                    SearchActivity.getInstance().addNewModules(homeModel);
                }
            }
