...
import com.sudnya.ecomm.Activity.LoginActivity;
import com.sudnya.ecomm.Activity.TodayDeal;
...
public class TodaysDealAdapter extends RecyclerView.Adapter<TodaysDealAdapter.ViewHolder> {
    ...
    public TodaysDealAdapter(List<HomeModel> homeModelList, Context context) {
        super();
    ...
    public void onBindViewHolder(ViewHolder Viewholder, int position) {
        ...
        Viewholder.wishlist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                TodayDeal.getInstance().addtoWishlist(homeModel);
            }
        });
        Viewholder.setClickListener(new ItemClickListener() {
            public void onClick(View view, int position, boolean isLongClick) {
                if (isLongClick) {
                    TodayDeal.getInstance().addNewModules(homeModel);
                } else {
                    TodayDeal.getInstance().addNewModules(homeModel);
                }
            }
